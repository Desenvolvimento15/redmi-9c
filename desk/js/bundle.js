!(function (modules) {
  ...
  function (module, exports) {
    window.modalPlayVideo = function ($target, $modal) {
      var videodata = $target.attr("data-video"),
        videoTitle = $target.attr("data-video-title");
      if (videodata) {
        var videosrc =
          "<iframe frameborder='0' allowfullscreen width='854' height='480' src='" +
          videodata +
          "' type='application/x-shockwave-flash' quality='high' align='middle'/></iframe>";
        return (
          $modal.addClass("modal-video"),
          $modal.find(".modal-body").html(""),
          $modal.find(".modal-body").append(videosrc),
          videoTitle && $modal.find(".modal-header .title").text(videoTitle),
          $modal.modal("show").on("hidden", function () {
            $modal.removeClass("modal-video"),
              $modal.find(".modal-body").html(""),
              $modal.find(".modal-header .title").text("");
          }),
          !1
        );
      }
  ...
  function (module, exports) {
    $(function () {
      ...
      $(window).on("scroll", function () {
        $(window).scrollTop() >= $sectionBox.offset().top - navHeight
          ? $navbarBox.addClass("J_fixNavbar")
          : $navbarBox.removeClass("J_fixNavbar");
      });
    });
  },
  function (module, exports) {
      ...
      $.fn.slider = function (options) {
        ...
        var windowWidth = $(window).width(),
          ...
          setup = function () {
            el.wrap(
              '<div class="' +
                ...
                '"><div class="ui-viewport"></div></div>'
            ),
              (slider.viewport = el.parent()),
              (slider.loader = $('<div class="ui-loading" />')),
              slider.viewport.prepend(slider.loader),
              el.css({
                width:
                  "horizontal" == slider.settings.mode
                    ? 100 * slider.children.length + 215 + "%"
                    : "auto",
                position: "relative",
              }),
            ...
            slider.viewport.css({
              ...
              (slider.controls.el = $('<div class="ui-controls" />')),
          ...
          getPagerQty = function () {
            ...
            if (slider.settings.moveSlides > 0)
              if (slider.settings.infiniteLoop)
                ...
                for (
                  var breakPoint = 0, counter = 0;
                  breakPoint < slider.children.length;
          ...
          populatePager = function () {
            for (
              var pagerHtml = "", pagerQty = getPagerQty(), i = 0;
              i < pagerQty;
              i++
            ) {
              var linkContent = "";
              ...
              $.isFunction(slider.settings.buildPager)
                ? ((linkContent = slider.settings.buildPager(i)),
                  slider.pagerEl.addClass("ui-custom-pager"))
                : ((linkContent = i + 1),
                  slider.pagerEl.addClass("ui-default-pager")),
                (pagerHtml +=
                  '<div class="ui-pager-item"><a href="" data-slide-index="' +
                  i +
                  '" class="ui-pager-link">' +
                  linkContent +
                  "</a></div>");
          ...
          appendPager = function () {
            slider.settings.pagerCustom
              ...
              : ((slider.pagerEl = $('<div class="ui-pager" />')),
                slider.settings.pagerSelector
                  ? $(slider.settings.pagerSelector).html(slider.pagerEl)
                  : slider.controls.el
                      .addClass("ui-has-pager")
          ...
          appendControls = function () {
            (slider.controls.next = $(
              '<a class="ui-next" href="">' + slider.settings.nextText + "</a>"
            )),
              (slider.controls.prev = $(
                '<a class="ui-prev" href="">' +
              ...
              slider.settings.nextSelector ||
                ...
                slider.controls.el
                  .addClass("ui-has-controls-direction")
                  .append(slider.controls.directionEl));
          },
          appendControlsAuto = function () {
            (slider.controls.start = $(
              '<div class="ui-controls-auto-item"><a class="ui-start" href="">' +
                slider.settings.startText +
                "</a></div>"
            )),
              (slider.controls.stop = $(
                '<div class="ui-controls-auto-item"><a class="ui-stop" href="">' +
                  slider.settings.stopText +
                  "</a></div>"
              )),
              (slider.controls.autoEl = $('<div class="ui-controls-auto" />')),
              slider.controls.autoEl.on("click", ".ui-start", clickStartBind),
              slider.controls.autoEl.on("click", ".ui-stop", clickStopBind),
          ...
          appendCaptions = function () {
            slider.children.each(function (index) {
              ...
              void 0 != title &&
                ("" + title).length &&
                $(this).append(
                  '<div class="ui-caption"><span>' + title + "</span></div>"
                );
            });
          },
          ...
          initTicker = function () {
            ...
            if ("next" == slider.settings.autoDirection)
              el.append(slider.children.clone().addClass("ui-clone"));
            else {
              el.prepend(slider.children.clone().addClass("ui-clone"));
                ...
                slider.viewport.hover(
                  ...
                  function () {
                    ...
                    var ratio = slider.settings.speed / totalDimens,
                      property =
                        "horizontal" == slider.settings.mode ? "left" : "top",
                      newSpeed =
                        ratio *
          ...
          tickerLoop = function (resumeSpeed) {
            ...
            "next" == slider.settings.autoDirection
              ? (position = el.find(".ui-clone").first().position())
          ...
          onTouchEnd = function (e) {
            ...
            if (
              ...
              distance >= slider.settings.swipeThreshold &&
                (slider.touch.start.x > slider.touch.end.x
                  ? el.goToNextSlide()
                  : el.goToPrevSlide(),
                el.stopAuto());
        ...
        return (
          (el.goToSlide = function (slideIndex, direction) {
            if (!slider.working && slider.active.index != slideIndex)
              if (
                ...
                slider.settings.pager && updatePagerActive(slider.active.index),
                slider.settings.controls && updateDirectionControls(),
                "fade" == slider.settings.mode)
              )
                slider.settings.adaptiveHeight &&
                ...
                if (
                  ...
                  if ("horizontal" == slider.settings.mode) {
                    var lastChild = slider.children.eq(
                  ...
                  var eq =
                      1 == slider.settings.moveSlides
                        ...
                        : (getPagerQty() - 1) * getMoveBy() -
                          (slider.children.length - slider.settings.maxSlides),
                    lastChild = el.children(".ui-clone").eq(eq);
                  position = lastChild.position();
                } else if ("next" == direction && 0 == slider.active.index)
                  (position = el
                    .find("> .ui-clone")
          ...
          (el.redrawSlider = function () {
            slider.children.add(el.find(".ui-clone")).width(getSlideWidth()),
    ...
    __webpack_require__(2),
      ...
      $(document).ready(function () {
        var $wayfarer = $("#wayfarer"),
          $sections = $wayfarer.find(".section"),
          _slider1 = "",
          _slider2 = "",
          _picSlider1 = "",
          _picSlider2 = "";
        ({
          zoom: function () {
            $wayfarer.css({ "font-size": ($wayfarer.width() / 2560) * 100 }),
              $(window).on("resize.zoom", function () {
                $wayfarer.css({
                  "font-size": ($wayfarer.width() / 2560) * 100,
                });
              });
          },
          lazyLoad: function () {
            $sections.visibleWatcher({
              onVisible: function ($elm, index) {
                $sections
                  ...
                  .addClass("preload")
                  .find(".video")
                  .attr({ preload: "auto", autoplay: "true" })
                  .end()
                  .find("img")
                  .each(function () {
          ...
          picSlider: function () {
            var w = $(window).width();
            _slider1 && _slider1.destroySlider(),
              (_slider1 = $(".J_pic1")
                .find(".list")
                .slider({
                  mode: "horizontal",
                  auto: !0,
                  pager: !0,
                  slideWidth: (867 * w) / 2560,
                  minSlides: 1,
                  maxSlides: 3,
                  moveSlides: 1,
                  controls: !1,
                  speed: 500,
                  slideMargin: (45 * w) / 2560,
                  pause: 3e3,
                  loop: !0,
                  onSliderLoad: function () {
                    $(".J_pic1,.J_pic1 .ui-viewport").css({
                      height: (675 * w) / 2560 + "px",
                    }),
                      $(".J_pic1")
                        .find(".list")
                        .css({
              ...
              _slider2 && _slider2.destroySlider(),
              (_slider2 = $(".J_pic2")
                .find(".list")
                .slider({
                  mode: "horizontal",
          ...
          silder1: function () {
            _picSlider1 && _picSlider1.destroySlider(),
              (_picSlider1 = $(".J_slider1").slider({
                auto: !0,
                pager: !0,
          ...
          silder2: function () {
            _picSlider2 && _picSlider2.destroySlider(),
              (_picSlider2 = $(".J_slider2").slider({
                auto: !0,
                pager: !0,
                slideWidth: $(window).width(),
                controls: !1,
          ...
          videoPlay: function () {
            $(".J_play").on("click", function () {
              modalPlayVideo($(this), $("#videowrap"));
            });
          },
          autoVideo: function () {
            $(".section").visibleWatcher({
              onVisible: function (elm, index) {
                $(elm).find("video").length && $(elm).find("video")[0].play();
              },
            });
          },
          init: function () {
