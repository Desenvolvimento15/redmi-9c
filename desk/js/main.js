!(function (modules) {
  ...
  function (module, exports) {
    module.exports = {
      global: {
        sg: { id: 2, lang: "zh-SG", currencyCode: "SGD", currencySymbol: "$" },
        my: { id: 3, lang: "ms-MY", currencyCode: "MYR", currencySymbol: "RM" },
        in: {
          id: 7,
          lang: "en-IN",
          currencyCode: "INR",
        ...
        ph: { id: 8, lang: "en-PH", currencyCode: "PHP", currencySymbol: "₱" },
        id: {
          id: 14,
          lang: "id-ID",
          currencyCode: "IDR",
  ...
  function (module, exports, __webpack_require__) {
    ...
    (window.doT = __webpack_require__(4)),
      (window.jQuery = __webpack_require__(5)),
      (window.$ = jQuery),
      (window._CONST = _const2.default),
      (window._B2C = (function () {
        var b2cNations = [];
        for (var theme in _nations2.default)
          for (var nation in _nations2.default[theme])
            _nations2.default[theme][nation].b2c && b2cNations.push(nation);
        return b2cNations;
      })()),
      ...
      (window.Xiaomi.CONST = _const2.default);
  },
  function (module, exports) {
    !(function () {
      "use strict";
    ...
    !(function (global, factory) {
      ...
      function (window, noGlobal) {
        ...
        function winnow(elements, qualifier, not) {
          return jQuery.isFunction(qualifier)
        ...
        function adoptValue(value, resolve, reject, noValue) {
          var method;
          try {
            value && jQuery.isFunction((method = value.promise))
              ? method.call(value).done(resolve).fail(reject)
              : value && jQuery.isFunction((method = value.then))
        ...
        function finalPropName(name) {
          ...
          return (
            ret || (ret = jQuery.cssProps[name] = vendorPropName(name) || name),
            ret
          );
        }
              ...
              "none" === display &&
                (restoreDisplay
                  ...
                  : (showHide([elem], !0),
                    ...
                    showHide([elem]))),
              ("inline" === display ||
                ("inline-block" === display && null != restoreDisplay)) &&
        ...
        var Sizzle = (function (window) {
          ...
          var i,
            ...
            disabledAncestor = addCombinator(
              function (elem) {
                return (
                  !0 === elem.disabled && ("form" in elem || "label" in elem)
                );
              },
                ...
                return doc !== document &&
                  ...
                  ? ((document = doc),
                    ...
                    (support.attributes = assert(function (el) {
                      return (
                        (el.className = "i"), !el.getAttribute("className")
                      );
                    })),
          ...
          for (i in {
            ...
            Expr.pseudos[i] = (function (type) {
              return function (elem) {
                return (
                  "input" === elem.nodeName.toLowerCase() && elem.type === type
                );
              };
            })(i);
        ...
        ((jQuery.fn.init = function (selector, context, root) {
          ...
          if (((root = root || rootjQuery), "string" == typeof selector)) {
            ...
            return (
              ...
              elem && ((this[0] = elem), (this.length = 1)),
              this
            );
          }
        ...
        var access = function (
          ...
          acceptData = function (owner) {
            return (
              1 === owner.nodeType || 9 === owner.nodeType || !+owner.nodeType
            );
          };
        (Data.uid = 1),
          (Data.prototype = {
        ...
        !(function () {
          ...
          input.setAttribute("type", "radio"),
            ...
            (support.noCloneChecked = !!div.cloneNode(!0).lastChild
              .defaultValue);
        })();
          ...
          tweeners: {
            "*": [
              function (prop, value) {
                ...
                return (
                  adjustCSS(tween.elem, prop, rcssNum.exec(value), tween), tween
                );
              },
            ],
          },
              ...
              attrHandle[name] = function (elem, name, isXML) {
                ...
                return (
                  isXML ||
                    ...
                    (ret =
                      null != getter(elem, name, isXML) ? lowercaseName : null),
          ...
          trigger: function (event, data, elem, onlyHandlers) {
            ...
            if (
              ...
              3 !== elem.nodeType &&
                ...
                (data =
                  null == data ? [event] : jQuery.makeArray(data, [event])),
                (special = jQuery.event.special[type] || {}),
                onlyHandlers ||
                  !special.trigger ||
        ...
        (originAnchor.href = location.href),
          ...
          jQuery.fn.extend({
            wrapAll: function (html) {
              ...
              return (
                this[0] &&
                  (jQuery.isFunction(html) && (html = html.call(this[0])),
          ...
          backdrop: function (callback) {
            ...
            if (this.isShown && this.options.backdrop) {
              ...
              if (
                ...
                this.$backdrop
                  .css({ width: "100%", height: pageHeight })
                  .click(
    ...
    (window.miscInfoDef = null),
      (function () {
        function User(context) {
          ...
          var _this = this;
          if (
            ((this.userId = Xiaomi.utils.cookie("cUserId")),
            (this.userName = ""),
            (this.msgNum = ""),
            (this.hasReview = ""),
            !this.userId)
          ...
          if (
            ((this.userName = this.userId
              ? cookieUserName
                ? cookieUserName.replace(/[<>]/g, "")
                : cookieUserName
              : ""),
            window._B2C.includes(_this.context.globalConfig.country))
          ) {
            var cookieMsgNum = Xiaomi.utils.cookie("msgNum");
            this.msgNum = cookieMsgNum;
            var cookieHasReview = Xiaomi.utils.cookie("hasReview");
            (this.hasReview = cookieHasReview),
              (null != this.msgNum && null != this.hasReview) ||
                ((window.miscInfoDef = $.ajax({
                  url:
                    ("https" == _this.context.globalConfig.protocol
                      ? _this.context.globalConfig.httpsOrderSite
                      : _this.context.globalConfig.orderSite) + "/misc/info",
                  timeout: 5e3,
                  dataType: "jsonp",
                  jsonp: "jsonpcallback",
                  jsonpCallback: "info",
                ...
                window.miscInfoDef.then(function (data) {
                  data &&
                    0 == data.errno &&
                    ((_this.msgNum = data.data.unread),
                    Xiaomi.utils.cookie("msgNum", _this.msgNum, {
                      expires: 0.0035,
          ...
          if (this.userName) this.signedIn();
            ...
            var data = { userId: 0 };
            ["id"].indexOf(GLOBAL_CONFIG.appLocal.name) > -1 &&
              (data.sid = "mi_overseaid_new"),
              /_poco$/.test(GLOBAL_CONFIG.appLocal.name)
                ? $.ajax({
                    ...
                    success: function (res) {
                      res.data &&
                        ...
                        ((_this.userName = res.data.profile.nickname
                          ...
                          : res.data.profile.userId),
                        _this.context.localCookie(
                          "XM_" + _this.userId + "_UN",
                          _this.userName
                        ),
                        _this.signedIn());
                    },
                ...
                : $.ajax({
                    ...
                    success: function (data) {
                      data &&
                        data.userId &&
                        ((_this.userName =
                          data.miliaoInfo && data.miliaoInfo.nickName
                            ? data.miliaoInfo.nickName
                            : data.userId),
                        _this.context.localCookie(
                          "XM_" + _this.userId + "_UN",
                          _this.userName
        ...
        (Xiaomi.prototype.logonUser = function () {
          ...
          (User.prototype.signedIn = function () {
            if (
              ...
              $("#J_signEntries").hide(),
              $("#J_signedUser").show(),
              this.msgNum && this.msgNum > 0)
            ) {
              var showNum = this.msgNum;
              parseInt(this.msgNum) > 99 && (showNum = "99<b>+</b>"),
                $("#J_msgNum")
                  .html("(" + showNum + ")")
                  .show();
            }
            this.hasReview && "true" === this.hasReview
      ...
      (Xiaomi.prototype.proxyIframe = function (callback, context) {
        var iframeBody =
          '<iframe src="' +
          ("https" == this.globalConfig.protocol
            ? this.globalConfig.httpsOrderSite
            : this.globalConfig.orderSite) +
          '/login/proxy" width="0" height="0" name="proxy" id="proxy" frameborder="0" scrolling="no"></iframe>';
        $(document.body).append(iframeBody),
          $("iframe[name=proxy]").on("load", function () {
            "function" == typeof callback && callback.call(context),
              $(this).remove();
          });
      }),
      ...
      (Xiaomi.utils = {
        ...
        isAllowStorageType: function (type) {
          var defaultAllowStorageType =
              ...
              [
                ...
                "se",
                "gr",
              ].indexOf(GLOBAL_CONFIG.appLocal.name)
                ? "0"
                : "0|1|2|3",
            allowStorageType =
              Xiaomi.utils.cookie("notice_gdpr_prefs") ||
              defaultAllowStorageType,
            policyType = {
              required: "0",
              functional: "1",
              advertising: "2",
        ...
        setCookie: function (type, key, value, config) {
          this.isAllowStorageType(type) &&
            this.cookie(
              key,
              value,
              config || { domain: GLOBAL_CONFIG.cookieDomain }
            );
        },
          ...
          var _default = {
              ...
              success: function (data) {
                ...
                if (void 0 !== data.errno) code = data.errno;
                  ...
                  if (void 0 === data.code)
                    return console.log("Error Format Interface"), !1;
                  code = data.code;
                }
                if (0 === parseInt(code))
                  options.successcallback && options.successcallback(data);
                else if (20006 === parseInt(code)) {
                  var Login_url_prefix =
                    GLOBAL_CONFIG.orderSite + "/site/login?redirectUrl=";
                  window.location.href =
                    Login_url_prefix + window.location.href;
      ...
      (Xiaomi.formatNum = function (num, local) {
        (local = local.replace("_poco", "")),
          "number" != typeof num && (num *= 1),
          "id" !== local && (num = num.toFixed(2)),
          (num = parseFloat((num + "").replace(/[^\d\.-]/g, "")) + "");
        var type,
          i,
          result = (num + "").split(".")[0].split(""),
          r = num.split(".")[1];
        for (
          type = "id" === local ? "." : ["in", "jp"].includes(local) ? "," : "",
            i = result.length;
          i > 3;
          i -= 3
        )
          result.splice(i - 3, 0, type);
        return r
          ? "es" === local
            ? r >= 10
              ? result.join("") + "." + r
      ...
      (Xiaomi.priceFormat = function (inputPrice, local, customOptions) {
        ...
        var CURRENCY_CONFIG = {
          ...
          currencySuffixymbol =
            customOptions && customOptions.isShowSuffix
              ? scmCurrencyConfig(local).currencySuffixymbol
              : "",
          currencyFunction = scmCurrencyConfig(local).currencyFunction,
          currencyExpect =
            "integer" === scmCurrencyConfig(local).currencyExpect
              ? "integer"
              : "decimal",
          currencyFormat =
            "post" === scmCurrencyConfig(local).currencyPosition
              ? "post"
              : "pre",
          ...
          price = (function (inputPrice, local) {
            var currencyFunction = scmCurrencyConfig(local).currencyFunction,
              isFormatted =
                Number.isNaN(Number(inputPrice)) ||
                (String(inputPrice) !== Number(inputPrice).toFixed(2) &&
                  String(inputPrice) + "0" !== Number(inputPrice).toFixed(2)),
              price = isFormatted
                ? ~["dotThousCommaDec", "spaceThousCommaDec"].indexOf(
                    currencyFunction
                  )
                  ? String(inputPrice + "")
                      .replace(/[ .]/g, "")
                      .replace(/,/g, ".")
                  : String(inputPrice + "").replace(/,/g, "")
                : String(inputPrice || 0);
            return Number(price);
          })(inputPrice, local),
          ...
          roundOff = function (priceNum, precision) {
            return (+priceNum).toFixed(
              0 !== precision
                ? precision
                : +(+priceNum).toFixed(0) == +(+priceNum).toFixed(2)
                ? 0
                : 2
            );
          },
          replaceSeparators = function (sNum, separators) {
            ...
            return (
              separators && separators.thousands
          ...
          getLast3Digits = function (sNum, separators) {
            ...
            return (
              (sNumParts[0] = String("000" + sNumParts[0]).slice(-3)),
              (newNum = sNumParts.join("."))
            );
          },
          ...
          spaceHundredsCommaThousCommaDec = function (sNum, options) {
            ...
            return newNum >= 1e3
              ? replaceSeparators(
                  Math.floor(newNum / 1e3) + "",
                  hundredSeparators
                ) +
                  "," +
                  getLast3Digits((newNum % 1e3).toFixed(2), thousandSeparators)
              : replaceSeparators(newNum + "", thousandSeparators);
          },
          transformForLocale = {
          ...
          formatFunc =
            transformForLocale[currencyFunction || "commaThousDotDec"],
          formattedPrice =
            "-1" === initNumString || "NaN" === initNumString
              ? currencyBlind
      ...
      (function () {
        function MiniCart(context) {
          this.context = context;
          var _this = this;
          (this.miniCartEntry = $("#J_miniCartEntry")),
            this.cartNum,
            (this.itemListTemplate = doT.template(
              $("#J_miniCartItemListTemplate").html()
            )),
            this.updateCartNum(
              Xiaomi.utils.cookie(
                "xm_user_" + this.context.globalConfig.country + "_num"
              )
            ),
            (this.removing = !1),
            this.miniCartEntry
              .on("click", ".J_itemRemove", function () {
                var gId = $(this).data("gid");
                return _this.removeGoods(gId), !1;
              })
              .on("mouseHover.miniCart.mi", function () {
                _this.miniCartEntry.find(".loading").show().siblings().hide(),
                  (_this.removing = !1),
                  _this.getData();
              });
        }
        ...
        (Xiaomi.prototype.loadMiniCart = function () {
          ...
          (MiniCart.prototype.updateCartNum = function (total) {
            total > 0
              ? ($("#J_miniCartNum").text(total),
                $("#J_miniCartIcon").attr("class", "iconfont-cartfull-24"))
              : ($("#J_miniCartNum").text(0),
                $("#J_miniCartIcon").attr("class", "iconfont-cartempty-24"));
          }),
            ...
            $.ajax({
              ...
              success: function (res) {
                _this.formatData(res),
                  _this.updateCartNum(res.data && res.data.total),
                  _this.miniCartEntry.trigger("contentChanged.mi"),
                  Xiaomi.utils.cookie(
                    "xm_user_" + _this.context.globalConfig.country + "_num",
            ...
            if ((_this.miniCartEntry.find(".loading").hide(), !res.errno)) {
              ...
              _this.removing ||
                _this.miniCartEntry
                  .find(".empty-cart")
                  .hide()
                  .siblings(".filled-cart")
                  .show();
              for (var i = 0; i < res.data.items.length; i += 1) {
                var item = res.data.items[i];
                (item.showType =
                  _CONST[GLOBAL_CONFIG.country].ShowType[item.show_type]),
                  void 0 === item.showType && (item.showType = "");
              }
              for (var i = 0; i < res.data.items.length; i++)
                -1 ===
                  ["it", "de", "jp", "nl", "es", "fr", "ru", "tr"].indexOf(
                    GLOBAL_CONFIG.country
                  ) &&
                  (res.data.items[i].salePrice = Xiaomi.formatNum(
                    res.data.items[i].salePrice,
                    GLOBAL_CONFIG.country
                  ));
              var listHtml = _this.itemListTemplate(res.data.items);
              _this.removing
                ? _this.removingItem(listHtml, function () {
                    _this.updateCartSummary(res.data);
                  })
                : (_this.updateCartSummary(res.data),
                  $("#J_miniCartItemList").html(listHtml));
            }
          }),
          (MiniCart.prototype.updateCartSummary = function (data) {
            var itemsStr = item;
            data.total > 1 && (itemsStr = items),
              $("#J_miniCartItemCount").text(data.total + " " + itemsStr),
              $("#J_miniCartSumPrice").text(data.productMoney_txt);
          }),
          (MiniCart.prototype.removingItem = function (listHtml, callback) {
            for (
              var oldHtmlLi = $("#J_miniCartItemList")
                  .html()
                  .match(/data\-gid=\"[^\"]+\"/g),
                newHtmlLi = listHtml.match(/data\-gid=\"([^\"]+)\"/g),
                i = 0;
              i < oldHtmlLi.length;
              i++
            ) {
              for (
                var j = 0;
                j < newHtmlLi.length && oldHtmlLi[i] != newHtmlLi[j];
                j++
              );
              j == newHtmlLi.length &&
                $("#J_miniCartItemList li:eq(" + i + ")").animate(
                  { height: 0, opacity: 0 },
                  "fast",
                  function () {
      ...
      (function () {
        ...
        function DM(options, context) {
          (this.context = context),
            (this.config = { sku: null, callback: null, sourceVal: "bigtap" }),
            (this.inTheQueue = !1),
        ...
        (Xiaomi.prototype.cart = function () {
          ...
          (Cart.prototype.cartAdd = function (url, success, complete) {
            var _this = this;
            Xiaomi.utils.setCookie(
              "analytical",
              "STATDOMAINID",
              String(GLOBAL_CONFIG.appLocal.xmst || ""),
              {
                expires: 365,
          ...
          (Cart.prototype.addGood = function (gid, callback, complete) {
            (gid = parseInt(gid)),
              (this.context.globalConfig.damiaoGoodsId = $.map(
                this.context.globalConfig.damiaoGoodsId,
                function (item, index) {
                  return parseInt(item);
                }
              )),
              -1 != $.inArray(gid, this.context.globalConfig.damiaoGoodsId)
                ? Xiaomi.utils.cookie("serviceToken")
                  ? new DM({ sku: gid, callback: callback }, this.context)
                  : Xiaomi.utils.cookie("cUserId")
                  ? this.context.proxyIframe(function () {
                      new DM({ sku: gid, callback: callback }, this.context);
                    }, this)
                  : (window.location.href =
                      this.context.globalConfig.orderSite + "/site/login")
                : complete
                ? this.cartAdd(
                    this.context.globalConfig.goUrl +
                      "/cart/add?from=pc&id=" +
                      gid +
                      "&tracking_addcart=" +
                      GLOBAL_CONFIG.appLocal.xmst +
                      "->{" +
                      (getQueryString("pageId") || "") +
                      "}::{" +
                      (getQueryString("viewId") || "") +
                      "}->{pc_buy_" +
                      gid +
                      "}::{btnBuyNow}",
                    callback,
          ...
          (Cart.prototype.addGoodWithOT = function (
            gid,
            callback,
            complete,
            goodsAmount,
            ...
            var getSettingsData = Object.assign(
                ...
                { app_platform: "pc", tip: $tip || "" }
              ),
              $xmotData = window.btoa(
                JSON.stringify({
                  common: getSettingsData,
                  biz: {
                    cart_add: { goods_amount: String(goodsAmount || "") },
                  },
                })
              );
            -1 != $.inArray(gid, this.context.globalConfig.damiaoGoodsId)
          ...
          (DM.prototype.getDmSys = function () {
            var _this = this,
              hdget =
                this.context.globalConfig.damiaoSite +
                "hdget/" +
                this.context.globalConfig.country +
                "?source=" +
                this.config.sourceVal +
                "&product=" +
                this.config.sku +
                "&addcart=1&m=1&_=" +
                new Date().getTime();
            Xiaomi.utils.cookie("WH_warehouse") &&
              "in" === this.context.globalConfig.country &&
              ...
              $.ajax({
                ...
                error: function () {
                  ...
                  _this.stopQueue(),
                    $("#xmDmError").modal({ show: !0, backdrop: "static" });
                },
                success: function (data) {
                  var url,
                    jsonStr = data.status,
                    ...
                    isOver =
                      !1 === jsonStr[_this.config.sku].hdstart &&
                      !0 === jsonStr[_this.config.sku].hdstop,
                  ...
                  return (
                    ...
                    (!0 === isOver
                      ...
                      : (_this.getDmTimer && clearTimeout(_this.getDmTimer),
                        void (token
                          ? ((url =
                              _this.context.globalConfig.goUrl +
                              "/cart/add?id=" +
                              _this.config.sku +
                              "&source=" +
                              _this.config.sourceVal +
                              "&token=" +
                              token),
                            _cart.cartAdd(
                              url,
                              _this.config.callback,
                              $.proxy(_this.stopQueue, _this)
                            ))
                          : (_this.inTheQueue || _this.startQueue(),
          ...
          (DM.prototype.startQueue = function () {
            ...
            $("#xmDmError").modal("hide"),
              $("#xmDmQueue").modal({ show: !0, backdrop: "static" }),
              _this.queueAnimate(),
              (_this.inTheQueue = !0),
        ...
        constructCountrySelect: function () {
          ...
          if (
            ($(".main-category").each(function () {
              "STORE" === $(this).find("a").text().trim().toUpperCase() &&
                ($store = $(this));
            }),
            $.each(GLOBAL_CONFIG.globalLocales, function (abbr, fullname) {
              viewerLocale === abbr || viewerLocale === abbr.toUpperCase()
                ? ((dropdownHtml +=
                    '<li class="region-entry global-entry"><a href="javascript:void(0);" class="active"  data-fullname="' +
                    fullname +
                    '" data-country="' +
                    abbr +
                    '">' +
                  ...
                  $("#J_selectRegin").text(fullname).attr("data-region", abbr),
                  $(".order-entry").show(),
                  $("#J_miniCartEntry").show())
                : ((dropdownHtml +=
                    '<li class="region-entry global-entry"><a href="javascript:void(0);" data-country="' +
                    abbr +
                    '" data-fullname="' +
                    fullname +
                    '">' +
                    fullname +
                    "</a></li>"),
                  (_this.currentCountry = viewerLocale));
            }),
            viewerLocale)
          ) {
            ...
            $.each(GLOBAL_CONFIG.globalLocales, function (abbr, fullname) {
              ...
              isInternational
                ? (dropdownHtml +=
                    '<li class="region-entry global-entry J_international"><a href="' +
                    GLOBAL_CONFIG.wwwSite +
                    '"  data-fullname="International">International</a></li>')
                : ((dropdownHtml +=
                    '<li class="region-entry global-entry J_international"><a href="' +
                    GLOBAL_CONFIG.wwwSite +
                    '"  data-fullname="International" class="active">International<i class="iconfont">&#xe932;</i></a></li>'),
                  $(".order-entry").hide(),
                  $("#J_miniCartEntry").hide(),
                  $store && $store.hide(),
                  $("#J_selectRegin")
                    .text("Select Region")
                    .attr("data-region", "en"));
            ...
            (viewerLocale = "en"),
              ...
              $("#J_selectRegin")
                .text("Select Region")
                .attr("data-region", "en");
          "" !== _this.currentCountry && null !== _this.currentCountry
            ? $.each(GLOBAL_CONFIG.globalLocalsUrl, function (name, url) {
                dropdownHtml +=
                  '<li class="region-entry"><a href="' +
                  url +
                  '">' +
                  name +
                  "</a></li>";
            ...
            : $.each(GLOBAL_CONFIG.separateSites, function (abbr, site) {
                (dropdownHtml +=
                  '<li class="region-entry global-entry"><a href="' +
                  site.link +
                  '" data-country="' +
                  abbr +
                  '" data-fullname="' +
            ...
            $(".J_regionList ul").html(dropdownHtml),
            $(".J_regionList").on("click", "a", function () {
              var $this = $(this);
              if (
                ($this.closest("li").hasClass("J_international")
                  ? ($(".order-entry").hide(), $("#J_miniCartEntry").hide())
                  : ($(".order-entry").show(), $("#J_miniCartEntry").show()),
                $this.closest("li").hasClass("global-entry"))
              ) {
                $(".J_regionList")
                  .find("a")
                  .each(function () {
                    var fullname =
                      ($(this).data("country"), $(this).data("fullname"));
                ...
                $("#J_selectRegin")
                  .text($(this).text())
                  .attr("data-region", country),
                  $(this)
                    .addClass("active")
                    .append('<i class="iconfont">&#xe932;</i>'),
                  $this.closest("li").hasClass("J_international")
                    ? (Xiaomi.utils.cookie("xm_viewer_locale", null, {
                        domain: GLOBAL_CONFIG.cookieDomain,
                        path: "/" + GLOBAL_CONFIG.country,
                        expires: 3650,
                      }),
                    ...
                    : (Xiaomi.utils.cookie("xm_viewer_locale", null, {
                      ...
                      setTimeout(function () {
                        (_this.currentCountry = $this.data("country")),
                          Xiaomi.utils.cookie(
                            "xm_viewer_locale",
    ...
    __webpack_require__(11),
      $(function () {
        function searchDirect() {
          var inActSuggestData = $(".search-direct-item.item-0").data(
              "suggest"
            ) || { in_act: !1, link: "", name: "" },
            userInput = $(".J_searchText").val();
          return (
            !(
              !inActSuggestData.in_act ||
              !inActSuggestData.link ||
              inActSuggestData.name !== userInput
            ) && (window.location.assign(inActSuggestData.link), !0)
          );
        }
        function commonSearch() {
          var searchHistory = (
              Xiaomi.utils.getLocalStorage("searchHistory") || []
            ).map(function (el) {
              return el.replace(/script/gi, "#*script*#");
            }),
            val = $.trim($(".J_searchText").val());
          "" !== val &&
            "-1" == $.inArray(val, searchHistory) &&
            (searchHistory.push(
              $(".J_searchText")
                .val()
                .replace(/script/gi, "#*script*#")
            ),
            Xiaomi.utils.setLocalStorage(
              "functional",
              "searchHistory",
          ...
          return (
            ...
            $(".search-history a").each(function (i, ele) {
              var newHrefStr =
                $(ele).attr("href") +
                encodeURIComponent(
                  $(ele)
              ...
              $(ele).attr("href", newHrefStr),
                $(ele).attr(
                  "onClick",
                  '_msq.push(["trackEvent", "search-search_page-search_log_click", "' +
                    newHrefStr +
                    '", ' +
                    JSON.stringify(JSON.stringify({ p1: $(ele).text() })) +
                    "])"
                );
            }),
            "" !== val &&
              (window._msq &&
                window._msq.push([
                  "trackEvent",
                  "search-search_page-search_click",
                  GLOBAL_CONFIG.orderSite +
                    "/search_" +
                    encodeURIComponent(val),
                  JSON.stringify({ p1: val }),
                ]),
              (val = val.replace(/[\-_'=+|\\\/]/g, " ")),
              window.location.href !=
                GLOBAL_CONFIG.orderSite +
          ...
          "" != searchVal && searchVal.length >= 1
            ? ((searchVal = searchVal.replace(/[\-_'=+|\\\/]/g, " ")),
              $.ajax({
                ...
                data: { word: searchVal, from: "pc" },
                dataType: "jsonp",
                jsonp: "jsonpcallback",
                jsonpcallback: "getSuggestList",
                success: function (data) {
                  var current = $(".J_searchText")
                    .val()
                    .replace(/[\-_'=+|\\\/]/g, " ");
                  if (
                    data &&
                    ...
                    listContainer.empty(),
                      ...
                      item &&
                        (window._msq &&
                          ...
                          window._msq.push([
                            "trackEvent",
                            "search-search_page-direct_search_show",
                            GLOBAL_CONFIG.wwwSite + "/" + item[0].tag,
                            JSON.stringify({
                        ...
                        item.map(function (el, i) {
                          var formatName = el.name.replace(
                              /[\-_'=+|\\\/]/g,
                              " "
                            ),
                            hrefProp = el.link
                              ? el.link
                              : GLOBAL_CONFIG.httpsOrderSite +
                                "/search_" +
                                formatName,
                            ...
                            directItem = $("<a/>")
                              .addClass(
                                withImage + " search-direct-item item-" + i
                              )
                              .attr("href", hrefProp)
                              .attr(
                                "onClick",
                                '_msq.push(["trackEvent", "search-search_page-direct_search_click", "' +
                                  GLOBAL_CONFIG.wwwSite +
                                  "/" +
                                  el.tag +
                                  '", ' +
                              ...
                              .attr("data-suggest", JSON.stringify(el));
                          el.image &&
                            "commodity" === el.item_type &&
                            $("<img/>")
                              .attr("src", el.image)
                              .attr("alt", "")
                              .appendTo(directItem);
                          ...
                          $("<div/>")
                            ...
                            el.in_act &&
                              ...
                              $("<strong/>")
                                .text(
                                  Xiaomi.CONST[GLOBAL_CONFIG.appLocal.name]
                                    .currencySymbol +
                                    Xiaomi.utils.formatPrice(el.price)
                                )
                                .appendTo(directInfo),
                            $(
                              '<i class="iconfont-arrowright-s-16"></i>'
                            ).appendTo(directItem);
                        })),
                      str &&
                        (listContainer.append(str),
                        $(".search-list a")
                          .not(".search-direct-item")
                          .each(function (i, ele) {
                            var newHrefStr =
                              $(ele).attr("href") +
                              encodeURIComponent(
                    ...
                    !(function () {
                      listContainer.find("a").each(function (i, ele) {
                        var strEl;
                        strEl = $(ele).hasClass("search-direct-item")
                          ? $(ele).find(".item-info div")
                          : $(ele);
                        var str = strEl.text(),
            ...
            : (listContainer.addClass("hide"),
              listContainer.empty(),
              "" === searchVal && $(".search-recommend").removeClass("hide"));
        }
        $(".J_foldingEntry").each(function () {
            ...
            $("#J_shopCategories").on(
              ...
              $("#J_searchHandler").on("click", function () {
                return (
                  searchUnfolding
                    ? ((searchUnfolding = !1),
                      $curtain.removeClass("search-unfolding"),
                      $(".site-search-backdrop").remove(),
                      $(this)
                        .children()
                        .addClass("iconfont-search-24")
                        .removeClass("iconfont-search-close-24"),
                      $("#J_siteSearch").hide(),
                      $("#J_siteSearchQuickLinks").removeClass("show"))
                    : ((searchUnfolding = !0),
                      $curtain.addClass("search-unfolding"),
                      $("#J_shopCategories")
                        .find("dl")
                        .eq(curExhibitIndex)
                        .children(".products-exhibit")
                      ...
                      $(this)
                        .children()
                        .removeClass("iconfont-search-24")
                        .addClass("iconfont-search-close-24"),
                      $("#J_siteSearch").show(),
                      $("#J_siteSearchInput").focus(),
                      $("#J_siteSearchQuickLinks").addClass("show")),
                  !1
                );
              }),
              $("body").on("click.foldingSearch.mi", function (e) {
                searchUnfolding &&
                  "J_curtain" != e.target.id &&
                  (($(e.target).parents("#J_curtain").length > 0 &&
                    0 == $(e.target).parent(".main-category").length) ||
                    ($("#J_searchHandler").trigger("click"),
          ...
          (function () {
            function showSitesList() {
              $sitesList.animate({ height: sitesListHeight }, "fast"),
                $switchHandle.addClass("active"),
                (shown = !0);
            }
            function hideSitesList() {
              $sitesList.animate({ height: 0 }, "fast", function () {
            ...
            $sitesList.css("width", $sitesList.children().outerWidth()),
              $switch.css("width", $sitesList.children().outerWidth()),
              $("#J_siteSwitchHandle").on("click", function () {
                return shown ? hideSitesList() : showSitesList(), !1;
              }),
              $("body").on("click.foldingSiteSwitch.mi", function (e) {
                0 == $(e.target).parents(".site-switch").length &&
                  shown &&
                  hideSitesList();
              });
          })(),
          $("#J_submitEmail").on("click", function () {
            ...
            return Xiaomi.utils.checkEmail(emailVal)
              ? ($.ajax({
                  type: "GET",
            ...
            $.ajax({
              ...
              success: function (data) {
                if (data && 0 == data.errno) {
                  ...
                  $(".quick-links").html(str),
                    $(".quick-links li a").map(function (idx, el) {
                      return $(el).attr(
                        "onClick",
                        '_msq.push(["trackEvent", "search-search_page-quick_links_click", "' +
                          $(el).attr("href") +
                          '", ' +
                          JSON.stringify(JSON.stringify({ p1: $(el).text() })) +
                          "])"
                      );
                    });
                }
        ...
        $(".search-section").on("click", ".J_header_search_true", function () {
          ...
          $(".search-section").on("click", ".J_clearHis", function () {
            ...
            searchHistory.splice($(this).parent("li").attr("data-index"), 1),
              Xiaomi.utils.setLocalStorage(
                "functional",
                "searchHistory",
                searchHistory
          ...
          $(".J_searchText").on(
            ...
            (function (fn, delay) {
              ...
              $(".search-recommend").addClass("hide"),
                $(this).val(
                  $(this).val().replace(/</g, "&lt;").replace(/>/g, "&gt;")
                ),
                renderSuggestList();
            }, 200)
          ),
          $(".J_searchText").on("focus", function () {
            "" == $(this).val()
              ? ($(".search-list").addClass("hide"),
                $(".search-recommend").removeClass("hide"))
              : ($(".search-recommend").addClass("hide"), renderSuggestList());
          }),
          $("#J_searchFormAction").on("submit", function (e) {
            e.preventDefault(), !searchDirect() && commonSearch();
          }),
          $("body").on("click", function (e) {
            $(".search-recommend").hasClass("hide") ||
              "J_searchTxt" === e.target.id ||
              "iconfont" === e.target.className ||
              $(".search-recommend").addClass("hide"),
              $(".search-list").hasClass("hide") ||
                "J_searchTxt" === e.target.id ||
                "iconfont" === e.target.className ||
                $(".search-list").addClass("hide");
          }),
  ...
  function (module, exports) {
    var stroageUtils = {
      ...
      setLocalStorage: function (type, key, data, local) {
        if (
          Xiaomi.utils.isAllowStorageType(type) &&
      ...
      getLocalStorage: function (key, local) {
        if (this.isLocalStorageSupport()) {
          ...
          if (local && localStorage.getItem(local)) {
            localData =
              JSON.parse(localStorage.getItem(local) || "{}")[key] || null;
      ...
      getSessionStorage: function (key, local) {
        if (this.isSessionStorageSupport()) {
          ...
          if (local && sessionStorage.getItem(local)) {
            localData =
              JSON.parse(sessionStorage.getItem(local) || "{}")[key] || null;
          } else
            localData = JSON.parse(sessionStorage.getItem(local) || "null");
          return localData;
        }
      },
    };
  ...
  function (module, exports) {
    var Base64 = {
      ...
      utils = {
        UTC_MAP: { in: 5.5, id: 7, sg: 8, my: 8, ph: 8, tw: 8, hk: 8, vn: 7 },
        Base64: Base64,
        getUTCDate: function (time, nationCode) {
          var timeBasis = time,
            zoneNum =
              this.UTC_MAP[nationCode || xiaomi.globalConfig.appLocal.name] ||
              0,
